...
with st.container():
    ...
    st.markdown("""
    Този анализ, изготвен от [Данни за добро](https://data-for-good.bg/), представя успехите на зрелостниците и предпочитаните предмети за втора матура в страната.
